...
export default function ProductCard({
  ...
  return (
    <motion.div
      ...
      className="group relative w-full rounded-2xl p-5 transition-all duration-500 border border-gray-200/80 hover:border-gray-300 cursor-pointer flex flex-col h-full justify-between"
